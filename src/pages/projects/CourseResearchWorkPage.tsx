...
const CourseResearchWorkPage = () => {
  ...
  const images: Record<string, string> = import.meta.glob(
    "./../../assets/media/projects/CourseResearchWork/*.{jpg,png,webp}",
    {
      eager: true,
      import: "default",
      query: "?url",
  ...
  return (
    <HomeWrapper>
      ...
      <PortfolioTitle>
        <span className="roboto-w-24">Презентация Курсовой научно исследовательской работы</span>
      </PortfolioTitle>      
      <PortfolioDesc className="roboto-w-18-thin">
      Презентация для выступления с курсовой научно исследовательской работой на тему:<br/>
