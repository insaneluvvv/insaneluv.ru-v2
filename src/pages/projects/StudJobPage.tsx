...
const StudJobPage = () => {
  ...
  const images: Record<string, string> = import.meta.glob(
    "./../../assets/media/projects/StudJob/*.{jpg,png,webp}",
    {
      eager: true,
      import: "default",
      query: "?url",
  ...
  return (
    <HomeWrapper>
      ...
      <PortfolioTitle>
        <span className="roboto-w-24">Поиск вакансий для студентов</span>
      </PortfolioTitle>      
      <PortfolioDesc className="roboto-w-18-thin">
      Это интерфейс, который создавался, как вариант дипломной работы. Вдохнавлен желанием студентов и преимущественно выпускников обрести свои первые офферы.<br/><br/>
