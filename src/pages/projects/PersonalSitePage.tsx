...
const PersonalSitePage = () => {
  ...
  return (
    <HomeWrapper>
      ...
      <PortfolioTitle>
        <span className="roboto-w-24">Личный сайт v1</span>
      </PortfolioTitle>      
      <PortfolioDesc className="roboto-w-18-thin">
      Это первый практический опыт во FrontEnd разработке.<br/><br/>
      Полностью разработал интерфейс собственного сайта-резюме и реализовал его на React.<br/><br/>
      Стек технологий:<br/>
