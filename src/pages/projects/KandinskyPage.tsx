...
const KandinskyPage = () => {
  ...
  const images: Record<string, string> = import.meta.glob(
    "./../../assets/media/projects/Kandinsky/*.{jpg,png,webp}",
    {
      eager: true,
      import: "default",
      query: "?url",
  ...
  return (
    <HomeWrapper>
      ...
      <PortfolioTitle>
        <span className="roboto-w-24">Сервис для обучения Kandinsky</span>
      </PortfolioTitle>      
      <PortfolioDesc className="roboto-w-18-thin">
      В ходе университетской практики в МИСИС, командой студентов создавался сервис для обучения нейронной сети Kandinsky от СБЕР путем разметки данных.<br/><br/>
